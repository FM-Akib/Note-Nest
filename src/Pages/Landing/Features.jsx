                    ...
                    <div className="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0">
                        <div>
                            ...
                            <div className="mt-6">
                                ...
                                <div className="mt-6">
                                    <a className="inline-flex rounded-lg bg-pink-600 px-4 py-1.5 text-base font-semibold leading-7 text-slate-700 shadow-sm ring-1 ring-pink-600 hover:bg-pink-700 hover:ring-pink-700"
                                        href="/login">
                                        Learn More
                                    </a>
                                </div>
