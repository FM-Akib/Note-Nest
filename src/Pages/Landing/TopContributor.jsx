    ...
    return (
        <div className=" px-16 mt-20">
            ...
            <RiMedalFill className="text-[#EFCA08] text-3xl mr-1" />
                <h1 className="font-semibold text-2xl">Top Contributors</h1>
            </div>


            <div className="py-2 bg-white border-[1px]  shadow-xl border-slate-500 rounded-3xl flex ">
            <Marquee >
                {
                    users?.map(auser=>  <div key={auser._id}  className="flex items-center flex-col ml-4 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-6 p-4 border rounded-2xl">
