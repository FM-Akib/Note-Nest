...
const TopContributor = () => {
    ...
    return (
        <div className="md:px-2 mt-16 md:mt-24 lg:mt-32">
            ...
            <Marquee >
                {
                    users?.map((auser, index)=>  <div key={auser._id}  className="flex items-center flex-col ml-4 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-6 p-4 border-e-2 ">
                    ...
                    <div>
                        ...
                        <div className=" prose prose-sm text-gray-400">
                            ...
                            <p className="font-semibold">Position - <span className="text-red-600 px-1 bg-emerald-100 rounded-lg">{index+1}</span></p>
                        </div>
