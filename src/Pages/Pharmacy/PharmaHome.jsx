...
const PharmaHome = () => {
    ...
    return (
        <div>
    <Helmet>
      <title>Note Nest - Pharma Home</title>
    </Helmet>
                   {/* Heading */}
        <div className="relative border-t border-gray-200 bg-gray-50 mb-2">
            ...
            <div className="relative mx-auto max-w-7xl px-6 pt-10 pb-12 sm:px-12 lg:pt-14">
        ...
        <div className="rounded-lg bg-white/50 ">
            <div className="flex w-full flex-wrap items-center justify-between gap-4 px-8 py-10 sm:px-16 lg:flex-nowrap">
                ...
                <div className="flex flex-wrap items-center justify-center gap-6 ">
                   <Link to={`${user?.email ? '/resourcesPharma/contribute' : '/login'}`}> <button className="bg-[#9a031e] hover:bg-[#181313] text-white font-semibold button-text flex items-center justify-center whitespace-nowrap rounded-md transition-all duration-300 px-8 py-3 text-xs sm:text-sm tracking-widest">Contribute</button></Link>
