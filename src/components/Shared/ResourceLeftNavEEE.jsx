...
const ResourceLeftNavEEE = ({closeNav }) => {
    ...
    return (
        <div className="h-screen bg-[#9A031E] p-4 text-white overflow-y-scroll">
            ...
            <li onClick={closeNav}> <Link to={`${user?.email ? '/resourcesEEE/contribute' : '/login'}`}>
                            ...
                            <ul className="flex flex-col gap-1 pl-2 mt-4 ">
                               {
                                ...
                                <Link to={`/resourcesEEE/content/${course.courseCode}`}>
                                    {course.courseCode}
                                </Link>
                               </li>)
                               }
...
export default ResourceLeftNavEEE;
