...
const ResourceLeftNav = () => {
    ...
    return (
        <div className="h-screen bg-red-600 p-4 text-white">
            <ul className="flex flex-col gap-2 max-w-[280px] mx-auto mt-24">
                <li>
                    <details className={`group ${isOpen ? 'open' : ''}`} onClick={toggleOpen}>
                        <summary className="flex items-center justify-between gap-2 p-2 font-medium marker:content-none hover:cursor-pointer">
                            ...
                            <svg className={`w-5 h-5 text-white transition ${isOpen ? 'rotate-90' : ''}`}
                ...
                <li>
                    <details className="group" onClick={toggleOpen}>
                        <summary className="flex items-center justify-between gap-2 p-2 font-medium marker:content-none hover:cursor-pointer">
                            <span className="flex gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
                                    stroke="currentColor" className="w-6 h-6">
