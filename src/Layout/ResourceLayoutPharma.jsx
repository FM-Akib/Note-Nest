...
import ResourceLeftNavPharma from "../components/Shared/ResourceLeftNavPharma";



const ResourceLayoutPharma = () => {
    ...
    return (
        ...
        <ResourceLeftNavPharma  closeNav={closeNav} />
...
export default ResourceLayoutPharma;